class Wave6 extends Phaser.Scene {
    constructor() {
        super("wave6Scene");
    }
    // preload
    ...
    create() {
      ...
      let healthConfig2 =
      {
        ...
        this.helicopter = new Helicopter(this, game.config.width, Math.floor(Math.random() * (game.config.height - 65)), 'helicopter', 0, 10, 3, 2).setOrigin(0, 0);
    ...
    update(time, delta,counter) {
      ...
      if (this.totalEnemyLives == 0) {
        ...
        this.bullets.children.each(function(bull) {
            ...
            if (this.checkCollision(bull, this.hammerhead)) {
                bull.setActive(false);
