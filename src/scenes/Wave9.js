class Wave9 extends Phaser.Scene {
    ...
    create() {
      ...
      let healthConfig2 =
      {
        ...
        this.ship03 = new Spaceship(this, game.config.width + Math.floor(Math.random() * 300), Math.floor(Math.random() * (game.config.height - 34)), 'e1', 0, 20, 2).setOrigin(0, 0);
        this.ship04 = new Spaceship(this, game.config.width + Math.floor(Math.random() * 300), Math.floor(Math.random() * (game.config.height - 34)), 'e1', 0, 30, 2).setOrigin(0, 0);
        this.ship05 = new Spaceship(this, game.config.width + Math.floor(Math.random() * 300), Math.floor(Math.random() * (game.config.height - 34)), 'e1', 0, 20, 2).setOrigin(0, 0);
        this.ship06 = new Spaceship(this, game.config.width, Math.floor(Math.random() * (game.config.height - 34)), 'e1', 0, 20, 2).setOrigin(0, 0);
        ...
        this.helicopter2 = new Helicopter(this, game.config.width + Math.floor(Math.random() * 300), Math.floor(Math.random() * (game.config.height - 65)), 'helicopter', 0, 10, 3, 2).setOrigin(0, 0);
        this.helicopter3 = new Helicopter(this, game.config.width + Math.floor(Math.random() * 300), Math.floor(Math.random() * (game.config.height - 65)), 'helicopter', 0, 10, 3, 2).setOrigin(0, 0);
        this.helicopter4 = new Helicopter(this, game.config.width, Math.floor(Math.random() * (game.config.height - 65)), 'helicopter', 0, 10, 3, 2).setOrigin(0, 0);
    ...
    update(time, delta,counter) {
      ...
      if (this.totalEnemyLives == 0) {
        ...
        if(parseInt(this.helicopter3.x) == 0)
        {
          //console.log("goteem");
        ...
        if(parseInt(this.helicopter4.x) == 0)
        {
          //console.log("goteem");
