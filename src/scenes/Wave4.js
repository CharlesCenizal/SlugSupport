...
class Wave4 extends Phaser.Scene {
    ...
    create() {
        ...
        this.wavyShip2 = new WavyShip(this, game.config.width + Math.floor(Math.random() * 300), Math.floor(Math.random() * (game.config.height - 65)), 'aircraft', 0, 10, 30, 1).setOrigin(0, 0);
